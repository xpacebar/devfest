...
class Breakout(db.Model):
    ...
    regdeets = db.relationship('UserRegistration', back_populates='break_deets')
...
class Donation(db.Model):  
    ...
    danatedby = db.relationship('User', backref="donordeets")
...
class UserRegistration(db.Model):
    ...
    break_deets = db.relationship('Breakout', back_populates='regdeets')
